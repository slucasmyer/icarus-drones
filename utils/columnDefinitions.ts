...
export const columnDefinitions: ColumnDefinitions = {
  Employees:  [
    { field: 'employeeID', headerName: 'employeeID', width: 90, type: 'number' },
  ...
  EmployeesProjects: [
    { field: 'employeeprojectID', headerName: 'employeeprojectID', width: 150, type: 'number' },
  ...
  Features: [
    { field: 'featureID', headerName: 'ID', width: 90, type: 'number' },
    { field: 'name', headerName: 'Name', width: 150, editable: true, type: 'string' },
